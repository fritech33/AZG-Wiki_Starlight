 ...
 */
export declare function isObject(value: unknown): value is Record<string | symbol | number, unknown>;
/**
 ...
 * ```
 */
export declare class Counter<K> extends Map<K, number> {
 ...
 * ```
 */
export declare class WeakCounter<K extends WeakKey> extends WeakMap<K, number> {
 ...
 * ```
 */
export declare class DefaultWeakMap<K extends WeakKey, V> extends WeakMap<K, V> {
  private readonly defaultFactory;
 ...
 */
export declare function isMathMLElement(node: Node): node is MathMLElement;
/**
 ...
 */
export declare function isNodeLike(value: unknown): value is Node;
/**
 * Checks if an unknown value is likely a DOM element.
 */
export declare function isElementLike(value: unknown): value is Element;
/**
 * Checks if the given value is likely a Window object.
 */
export declare function isWindowLike(value: unknown): value is Window;
/**
 * Gets the window object for the given target or the global window object if no
 * target is provided.
 */
export declare function getWindow(target?: Node | ShadowRoot | Document | null): Window & typeof globalThis;
/**
 * Gets the document for the given target or the global document if no target is
 * provided.
 */
export declare function getDocument(target?: Element | Window | Node | Document | null): Document;
/**
 * Gets a reference to the root node of the document based on the given target.
 */
export declare function getDocumentElement(target?: Element | Node | Window | Document | null): HTMLElement;
//#endregion
 ...
 * @public
 */
export declare function mapGroupBy<K, T>(items: Iterable<T>, keySelector: (item: T, index: number) => K): Map<K, T[]>;
//#endregion
 ...
 * @public
 */
export declare function mapValues<ValueIn, ValueOut>(object: Record<string, ValueIn>, callback: (value: ValueIn, key: string) => ValueOut): Record<string, ValueOut>;
//#endregion
 ...
 * @public
 */
export declare function objectEntries<T extends Record<string, any>>(obj: T): ObjectEntries<T>[];
//#endregion
 ...
 */
export declare const supportsRegexLookbehind: () => boolean;
//#endregion
 ...
 * ```
 */
export declare function throttle<T extends (this: any, ...args: any[]) => unknown>(callback: T, delay: number, options?: ThrottleOptions): (this: ThisParameterType<T>, ...args: Parameters<T>) => void;
//#endregion
export type { ObjectEntries, ThrottleOptions };